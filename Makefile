...
# Docker Compoer Project Filenames
REL_PROJECT := $(PROJECT_NAME)$(BUILD_ID)
DEV_PROJECT := $(REL_PROJECT)dev 

# Application Service Name - must match Docker Compose release specification application service Filenames
APP_SERVICE_NAME := app

# Build tag expressio - can be used to evaluate a shell expression at runtime
...
# Use these settings to specify a custom Docker DOCKER_REGISTRY
...
build:
		...
		${INFO} "Copying artifacts to target foler..."
...
release:
		...
		${INFO} "Running databas migrations..."
...
clean:
		...
		@ docker-compose -p $(DEV_PROJECT) -f docker/dev/docker-compose.yml kill
		@ docker-compose -p $(DEV_PROJECT) -f docker/dev/docker-compose.yml rm -f -v
